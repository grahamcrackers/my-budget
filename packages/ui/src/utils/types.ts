// borrowed from https://github.com/tailwindlabs/headlessui/blob/main/packages/%40headlessui-react/src/types.ts
...
const __ = "7a417ed0-0b41-4e2b-b429-200a83bdbfef" as const;
